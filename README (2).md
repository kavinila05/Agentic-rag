...
These are **future extensions**, not required for the current POC.

------------------------------------------------------------------------

# Learning Goal

The main goal of this project is to understand the difference between:
...
Decide whether it is sufficient
        ↓
Correct the retrieval when necessary
        ↓
Use other tools when required
        ↓
Combine the results
        ↓
...
This keeps the project small while demonstrating the core idea behind
Agentic RAG.
